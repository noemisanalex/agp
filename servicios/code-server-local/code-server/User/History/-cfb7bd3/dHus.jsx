      ...
      <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0">
        <div className="rounded-xl overflow-hidden shadow-2xl transition-all duration-500 hover:brightness-110 hover:scale-105">
          <video
            ...
            playsInline
            controls
            poster="/imagenes/video-poster.jpg" // Añadido un poster por si el video no carga
            onError={(e) => {
              console.error("Error en la carga del video:", e);
              if (!videoErrorHandled) {
                setVideoErrorHandled(true);
                // Podrías mostrar una imagen alternativa aquí
              }
            }}
          />
        </div>
      ...
      >
        <img
          ...
          onError={(e) => {
            ...
            e.target.src = "/imagenes/logo-fallback.png"; // Imagen de respaldo
