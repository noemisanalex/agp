...
export default function DashboardLayout() {
  ...
  // Asegurar que el cuerpo ocupe toda la altura de la ventana
  useEffect(() => {
    document.body.style.height = '100vh';
    document.body.style.margin = '0';
    document.body.style.overflow = 'hidden';
    
    // Aplicar estilos al html y root también
  ...
  return (
    <div className="flex h-screen w-full font-sans text-white bg-transparent overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col h-screen">
        ...
        >
          <Suspense fallback={<div className="p-6 text-white h-full flex items-center justify-center">Cargando sección...</div>}>
            <Routes>
              <Route path="home" element={<Home />} />
              <Route path="firestore" element={<TestFirestore />} />
